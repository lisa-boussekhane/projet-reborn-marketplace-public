...
(2, 'public/uploads/sebastian.png', NULL, 2),
(3, 'public/uploads/lottie.png', NULL, 3),
(4, 'public/uploads/johnnie.png', NULL, 4),
(5, 'public/uploads/alina.png', NULL, 5),
(6, 'public/uploads/sebastian.png', NULL, 6),
(7, 'public/uploads/lottie.png', NULL, 7),
(8, 'public/uploads/johnnie.png', NULL, 8),
(9, 'public/uploads/alina.png', NULL, 9),
(10, 'public/uploads/sebastian.png', NULL, 10),
(11, 'public/uploads/lottie.png', NULL, 11),
(12, 'public/uploads/johnnie.png', NULL, 12);
SELECT setval('"media_id_seq"', (SELECT MAX(id) + 1 FROM "media"));
-- SELECT setval('"media_id_seq"', (SELECT MAX(id) + 1 FROM "media")); Alina Seb Lottie Johnnie
